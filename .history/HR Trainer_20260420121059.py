...
for hw in np.arange(0.30, 1.01, 0.01):
    ...
    _hprec = _top10_precision(_hp, val_y, val_date_idx, val_game_idx)
...
prec_g = _top10_precision(cv_probs_g, val_y, val_date_idx, val_game_idx)
prec_h = _top10_precision(cv_probs_h, val_y, val_date_idx, val_game_idx)
print(f'  Top-10 precision: C={prec_c:.1%}  D={prec_d:.1%}  E={prec_e:.1%}  F={prec_f:.1%}  G={prec_g:.1%}  H={prec_h:.1%}  A={prec_a:.1%}')
