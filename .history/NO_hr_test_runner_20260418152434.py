...
def build_dn_park_table(pf_blend):
    ...
    for team in all_teams:
        ...
        table[(team, 'day')]   = day_pf
        table[(team, 'prime')] = night_pf  # prime time uses night park factor
        table[(team, 'late')]  = night_pf  # late games use night park factor
    return table
...
def score_batter(bid, opp_pid, home_team, game_pk, time_slot, is_home,
    ...
    park     = dn_park.get((home_team, time_slot), 1.0)
