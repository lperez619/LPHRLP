...
def build_training_data(year, bvp_career=None, weather_splits=None):
    ...
    curr_team_pitch = team_pitch_cache.get(year, {}).get(g_date_str, {}) # Wait, team_pitch_cache has year layer? No, the cache is year -> team -> date. So I should restructure the dictionary or lookup.
